...
$cambiar_nueva_contrasena =$_POST["cambiar_nueva-contrasena"];
...
if($cambiar_contrasena!=$cambiar_nueva_contrasena){  

    header("location:../Fronend/Cambiar-Contrasena/Cambiar-Contrasena.php?fallo=con");

}else if($numero_registro==1){

    header("location:../Fronend/Cambiar-Contrasena/Cambiar-Contrasena.php?fallo=false"); 
}else if($numero_registro==0){

    header("location:../Fronend/Cambiar-Contrasena/Cambiar-Contrasena.php?fallo=true"); 
